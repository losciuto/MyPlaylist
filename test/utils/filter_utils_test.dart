...
void main() {
  group('FilterUtils Tests', () {
    ...
    final v2 = Video(
      id: 2,
      path: '/movies/drama/Godfather.mkv',
      title: 'The Godfather',
      year: '1972',
      genres: 'Crime',
      rating: 9.2,
    ...
    final v3 = Video(
      id: 3,
      path: '/movies/comedy/Superbad.mkv',
      title: 'Superbad',
      year: '2007',
      genres: 'Comedy',
      rating: 7.6,
    ...
    test('Sorts by Title Ascending', () {
      final list = [
        ...
        v2,
        v3,
      ]; // Matrix, Godfather, Superbad -> Godfather, Superbad, Matrix (alphabetical)
