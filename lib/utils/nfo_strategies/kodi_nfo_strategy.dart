...
class KodiNfoStrategy implements NfoStrategy {
  ...
  Future<Map<String, dynamic>?> parse(String content, String nfoPath) async {
    ...
    final year =
        getString('year') ?? getString('premiered')?.split('-').firstOrNull;
    ...
    if (ratingStr == null ||
      ...
      final ratingsBlock = document.rootElement
          .findElements('ratings')
          .firstOrNull;
      ...
      if (bestNode != null) {
        ...
        ratingStr = valueNode != null
            ? valueNode.innerText.trim()
            : bestNode.innerText.trim();
      }
    }
    ...
    if (setNode != null) {
      ...
      saga = nameNode != null
          ? clean(nameNode.innerText)
          : clean(setNode.innerText);
    }
